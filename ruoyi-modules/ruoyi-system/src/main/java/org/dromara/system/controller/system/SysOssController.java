...
public class SysOssController extends BaseController {
    ...
    public RequestResponse<List<SysOssVo>> listByIds(@NotEmpty(message = "主键不能为空")
    ...
    public RequestResponse<SysOssUploadVo> upload(@RequestPart("file") MultipartFile file) {
        if (ObjectUtil.isNull(file)) {
            return RequestResponse.fail("上传文件不能为空");
        }
        ...
        return RequestResponse.ok(uploadVo);
    }
